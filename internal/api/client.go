...
// Defines values for PostCancelinvoiceParamsMark.
const (
	PostCancelinvoiceParamsMarkMark PostCancelinvoiceParamsMark = "{mark}"
)

// Defines values for PostCancelinvoiceParamsAadeUserId.
const (
	PostCancelinvoiceParamsAadeUserIdAadeUserId PostCancelinvoiceParamsAadeUserId = "{aade-user-id}"
)

// Defines values for GetRequestdocsParamsMark.
const (
	GetRequestdocsParamsMarkMark GetRequestdocsParamsMark = "{mark}"
)

// Defines values for GetRequestdocsParamsNextPartitionKey.
const (
	GetRequestdocsParamsNextPartitionKeyNextPartitionKey GetRequestdocsParamsNextPartitionKey = "{nextPartitionKey}"
)

// Defines values for GetRequestdocsParamsNextRowKey.
const (
	GetRequestdocsParamsNextRowKeyNextRowKey GetRequestdocsParamsNextRowKey = "{nextRowKey}"
)

// Defines values for GetRequestdocsParamsAadeUserId.
const (
	GetRequestdocsParamsAadeUserIdAadeUserId GetRequestdocsParamsAadeUserId = "{aade-user-id}"
)

// Defines values for GetRequesttransmitteddocsParamsMark.
const (
	Mark GetRequesttransmitteddocsParamsMark = "{mark}"
)

// Defines values for GetRequesttransmitteddocsParamsNextPartitionKey.
const (
	GetRequesttransmitteddocsParamsNextPartitionKeyNextPartitionKey GetRequesttransmitteddocsParamsNextPartitionKey = "{nextPartitionKey}"
)

// Defines values for GetRequesttransmitteddocsParamsNextRowKey.
const (
	GetRequesttransmitteddocsParamsNextRowKeyNextRowKey GetRequesttransmitteddocsParamsNextRowKey = "{nextRowKey}"
)

// Defines values for GetRequesttransmitteddocsParamsDateFrom.
const (
	DateFrom GetRequesttransmitteddocsParamsDateFrom = "{dateFrom}"
)

// Defines values for GetRequesttransmitteddocsParamsDateTo.
const (
	DateTo GetRequesttransmitteddocsParamsDateTo = "{dateTo}"
)

// Defines values for GetRequesttransmitteddocsParamsAadeUserId.
const (
	GetRequesttransmitteddocsParamsAadeUserIdAadeUserId GetRequesttransmitteddocsParamsAadeUserId = "{aade-user-id}"
)

// Defines values for PostSendexpensesclassificationParamsAadeUserId.
const (
	PostSendexpensesclassificationParamsAadeUserIdAadeUserId PostSendexpensesclassificationParamsAadeUserId = "{aade-user-id}"
)

// Defines values for PostSendincomeclassificationParamsAadeUserId.
const (
	PostSendincomeclassificationParamsAadeUserIdAadeUserId PostSendincomeclassificationParamsAadeUserId = "{aade-user-id}"
)

// Defines values for PostSendinvoicesParamsAadeUserId.
const (
	PostSendinvoicesParamsAadeUserIdAadeUserId PostSendinvoicesParamsAadeUserId = "{aade-user-id}"
)
...
type PostCancelinvoiceParams struct {
	...
	Mark PostCancelinvoiceParamsMark `form:"mark" json:"mark"`
...
type GetRequestdocsParams struct {
	// Mark Μοναδικός Αριθμός Καταχώρησης
	Mark *GetRequestdocsParamsMark `form:"mark,omitempty" json:"mark,omitempty"`

	// NextPartitionKey Παράμετρος για την τμηματική λήψη των αποτελεσμάτων
	NextPartitionKey *GetRequestdocsParamsNextPartitionKey `form:"nextPartitionKey,omitempty" json:"nextPartitionKey,omitempty"`

	// NextRowKey Παράμετρος για την τμηματική λήψη των αποτελεσμάτων
	NextRowKey *GetRequestdocsParamsNextRowKey `form:"nextRowKey,omitempty" json:"nextRowKey,omitempty"`

	// AadeUserId aade-user-id
...
type GetRequesttransmitteddocsParams struct {
	// Mark Μοναδικός Αριθμός Καταχώρησης
	Mark GetRequesttransmitteddocsParamsMark `form:"mark" json:"mark"`

	// NextPartitionKey Παράμετρος για την τμηματική λήψη των αποτελεσμάτων
	NextPartitionKey *GetRequesttransmitteddocsParamsNextPartitionKey `form:"nextPartitionKey,omitempty" json:"nextPartitionKey,omitempty"`

	// NextRowKey Παράμετρος για την τμηματική λήψη των αποτελεσμάτων
	NextRowKey *GetRequesttransmitteddocsParamsNextRowKey `form:"nextRowKey,omitempty" json:"nextRowKey,omitempty"`

	// DateFrom Αρχή χρονικού διαστήματος αναζήτησης για την ημερομηνία έκδοσης
	DateFrom *GetRequesttransmitteddocsParamsDateFrom `form:"dateFrom,omitempty" json:"dateFrom,omitempty"`

	// DateTo Τέλος χρονικού διαστήματος αναζήτησης για την ημερομηνία έκδοσης
	DateTo *GetRequesttransmitteddocsParamsDateTo `form:"dateTo,omitempty" json:"dateTo,omitempty"`

	// InvType Τύπος παραστατικού, πρέπει να αντιστοιχεί σύμφωνα με τον πίνακα 8.1 του παραρτήματος
	InvType *string `form:"invType,omitempty" json:"invType,omitempty"`

	// ReceiverVatNumber ΑΦΜ αντισυμβαλλόμενου
	ReceiverVatNumber *string `form:"receiverVatNumber,omitempty" json:"receiverVatNumber,omitempty"`
...
// GetRequesttransmitteddocsParamsDateFrom defines parameters for GetRequesttransmitteddocs.
type GetRequesttransmitteddocsParamsDateFrom string

// GetRequesttransmitteddocsParamsDateTo defines parameters for GetRequesttransmitteddocs.
type GetRequesttransmitteddocsParamsDateTo string
...
func NewGetRequesttransmitteddocsRequest(server string, params *GetRequesttransmitteddocsParams) (*http.Request, error) {
	...
	if params.InvType != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "invType", runtime.ParamLocationQuery, *params.InvType); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.ReceiverVatNumber != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "receiverVatNumber", runtime.ParamLocationQuery, *params.ReceiverVatNumber); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
